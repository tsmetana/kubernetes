...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshot, InType: reflect.TypeOf(&VolumeSnapshot{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotCondition, InType: reflect.TypeOf(&VolumeSnapshotCondition{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotData, InType: reflect.TypeOf(&VolumeSnapshotData{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotDataCondition, InType: reflect.TypeOf(&VolumeSnapshotDataCondition{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotDataList, InType: reflect.TypeOf(&VolumeSnapshotDataList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotDataSource, InType: reflect.TypeOf(&VolumeSnapshotDataSource{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotDataSpec, InType: reflect.TypeOf(&VolumeSnapshotDataSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotDataStatus, InType: reflect.TypeOf(&VolumeSnapshotDataStatus{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotList, InType: reflect.TypeOf(&VolumeSnapshotList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotSpec, InType: reflect.TypeOf(&VolumeSnapshotSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_VolumeSnapshotStatus, InType: reflect.TypeOf(&VolumeSnapshotStatus{})},
...
// DeepCopy_api_VolumeSnapshot is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshot(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshot)
		out := out.(*VolumeSnapshot)
		*out = *in
		if newVal, err := c.DeepCopy(&in.ObjectMeta); err != nil {
			return err
		} else {
		...
		if err := DeepCopy_api_VolumeSnapshotStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_api_VolumeSnapshotCondition is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotCondition(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotCondition)
		out := out.(*VolumeSnapshotCondition)
		*out = *in
		out.LastTransitionTime = in.LastTransitionTime.DeepCopy()
		return nil
	}
...
// DeepCopy_api_VolumeSnapshotData is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotData(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotData)
		out := out.(*VolumeSnapshotData)
		*out = *in
		if newVal, err := c.DeepCopy(&in.ObjectMeta); err != nil {
			return err
		} else {
		...
		if err := DeepCopy_api_VolumeSnapshotDataSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_api_VolumeSnapshotDataStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_api_VolumeSnapshotDataCondition is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotDataCondition(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotDataCondition)
		out := out.(*VolumeSnapshotDataCondition)
		*out = *in
		out.LastTransitionTime = in.LastTransitionTime.DeepCopy()
		return nil
	}
...
// DeepCopy_api_VolumeSnapshotDataList is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotDataList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotDataList)
		out := out.(*VolumeSnapshotDataList)
		*out = *in
		if in.Items != nil {
			in, out := &in.Items, &out.Items
			*out = make([]VolumeSnapshotData, len(*in))
			for i := range *in {
				if err := DeepCopy_api_VolumeSnapshotData(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_api_VolumeSnapshotDataSource is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotDataSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotDataSource)
		out := out.(*VolumeSnapshotDataSource)
		*out = *in
		if in.GCEPersistentDisk != nil {
			in, out := &in.GCEPersistentDisk, &out.GCEPersistentDisk
			*out = new(GCEPersistentDiskVolumeSource)
...
// DeepCopy_api_VolumeSnapshotDataSpec is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotDataSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotDataSpec)
		out := out.(*VolumeSnapshotDataSpec)
		*out = *in
		if err := DeepCopy_api_VolumeSnapshotDataSource(&in.VolumeSnapshotDataSource, &out.VolumeSnapshotDataSource, c); err != nil {
			return err
		}
...
// DeepCopy_api_VolumeSnapshotDataStatus is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotDataStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotDataStatus)
		out := out.(*VolumeSnapshotDataStatus)
		*out = *in
		out.CreationTimestamp = in.CreationTimestamp.DeepCopy()
		if in.Conditions != nil {
			in, out := &in.Conditions, &out.Conditions
			*out = make([]VolumeSnapshotDataCondition, len(*in))
			for i := range *in {
				if err := DeepCopy_api_VolumeSnapshotDataCondition(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_api_VolumeSnapshotList is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotList)
		out := out.(*VolumeSnapshotList)
		*out = *in
		if in.Items != nil {
			in, out := &in.Items, &out.Items
			*out = make([]VolumeSnapshot, len(*in))
			for i := range *in {
				if err := DeepCopy_api_VolumeSnapshot(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_api_VolumeSnapshotSpec is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotSpec)
		out := out.(*VolumeSnapshotSpec)
		*out = *in
		return nil
	}
}

// DeepCopy_api_VolumeSnapshotStatus is an autogenerated deepcopy function.
func DeepCopy_api_VolumeSnapshotStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*VolumeSnapshotStatus)
		out := out.(*VolumeSnapshotStatus)
		*out = *in
		out.CreationTimestamp = in.CreationTimestamp.DeepCopy()
		if in.Conditions != nil {
			in, out := &in.Conditions, &out.Conditions
			*out = make([]VolumeSnapshotCondition, len(*in))
			for i := range *in {
				if err := DeepCopy_api_VolumeSnapshotCondition(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
