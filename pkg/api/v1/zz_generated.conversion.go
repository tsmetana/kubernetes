...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_VolumeSnapshot_To_api_VolumeSnapshot,
		Convert_api_VolumeSnapshot_To_v1_VolumeSnapshot,
		Convert_v1_VolumeSnapshotCondition_To_api_VolumeSnapshotCondition,
		Convert_api_VolumeSnapshotCondition_To_v1_VolumeSnapshotCondition,
		Convert_v1_VolumeSnapshotData_To_api_VolumeSnapshotData,
		Convert_api_VolumeSnapshotData_To_v1_VolumeSnapshotData,
		Convert_v1_VolumeSnapshotDataCondition_To_api_VolumeSnapshotDataCondition,
		Convert_api_VolumeSnapshotDataCondition_To_v1_VolumeSnapshotDataCondition,
		Convert_v1_VolumeSnapshotDataList_To_api_VolumeSnapshotDataList,
		Convert_api_VolumeSnapshotDataList_To_v1_VolumeSnapshotDataList,
		Convert_v1_VolumeSnapshotDataSource_To_api_VolumeSnapshotDataSource,
		Convert_api_VolumeSnapshotDataSource_To_v1_VolumeSnapshotDataSource,
		Convert_v1_VolumeSnapshotDataSpec_To_api_VolumeSnapshotDataSpec,
		Convert_api_VolumeSnapshotDataSpec_To_v1_VolumeSnapshotDataSpec,
		Convert_v1_VolumeSnapshotDataStatus_To_api_VolumeSnapshotDataStatus,
		Convert_api_VolumeSnapshotDataStatus_To_v1_VolumeSnapshotDataStatus,
		Convert_v1_VolumeSnapshotList_To_api_VolumeSnapshotList,
		Convert_api_VolumeSnapshotList_To_v1_VolumeSnapshotList,
		Convert_v1_VolumeSnapshotSpec_To_api_VolumeSnapshotSpec,
		Convert_api_VolumeSnapshotSpec_To_v1_VolumeSnapshotSpec,
		Convert_v1_VolumeSnapshotStatus_To_api_VolumeSnapshotStatus,
		Convert_api_VolumeSnapshotStatus_To_v1_VolumeSnapshotStatus,
...
func autoConvert_v1_VolumeSnapshot_To_api_VolumeSnapshot(in *VolumeSnapshot, out *api.VolumeSnapshot, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_VolumeSnapshotSpec_To_api_VolumeSnapshotSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_VolumeSnapshotStatus_To_api_VolumeSnapshotStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_VolumeSnapshot_To_api_VolumeSnapshot is an autogenerated conversion function.
func Convert_v1_VolumeSnapshot_To_api_VolumeSnapshot(in *VolumeSnapshot, out *api.VolumeSnapshot, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshot_To_api_VolumeSnapshot(in, out, s)
}

func autoConvert_api_VolumeSnapshot_To_v1_VolumeSnapshot(in *api.VolumeSnapshot, out *VolumeSnapshot, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_api_VolumeSnapshotSpec_To_v1_VolumeSnapshotSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_api_VolumeSnapshotStatus_To_v1_VolumeSnapshotStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_VolumeSnapshot_To_v1_VolumeSnapshot is an autogenerated conversion function.
func Convert_api_VolumeSnapshot_To_v1_VolumeSnapshot(in *api.VolumeSnapshot, out *VolumeSnapshot, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshot_To_v1_VolumeSnapshot(in, out, s)
}

func autoConvert_v1_VolumeSnapshotCondition_To_api_VolumeSnapshotCondition(in *VolumeSnapshotCondition, out *api.VolumeSnapshotCondition, s conversion.Scope) error {
	out.Type = api.VolumeSnapshotConditionType(in.Type)
	out.Status = api.ConditionStatus(in.Status)
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
	out.Message = in.Message
...
// Convert_v1_VolumeSnapshotCondition_To_api_VolumeSnapshotCondition is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotCondition_To_api_VolumeSnapshotCondition(in *VolumeSnapshotCondition, out *api.VolumeSnapshotCondition, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotCondition_To_api_VolumeSnapshotCondition(in, out, s)
}

func autoConvert_api_VolumeSnapshotCondition_To_v1_VolumeSnapshotCondition(in *api.VolumeSnapshotCondition, out *VolumeSnapshotCondition, s conversion.Scope) error {
	out.Type = VolumeSnapshotConditionType(in.Type)
	out.Status = ConditionStatus(in.Status)
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
	out.Message = in.Message
...
// Convert_api_VolumeSnapshotCondition_To_v1_VolumeSnapshotCondition is an autogenerated conversion function.
func Convert_api_VolumeSnapshotCondition_To_v1_VolumeSnapshotCondition(in *api.VolumeSnapshotCondition, out *VolumeSnapshotCondition, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotCondition_To_v1_VolumeSnapshotCondition(in, out, s)
}

func autoConvert_v1_VolumeSnapshotData_To_api_VolumeSnapshotData(in *VolumeSnapshotData, out *api.VolumeSnapshotData, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_VolumeSnapshotDataSpec_To_api_VolumeSnapshotDataSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_VolumeSnapshotDataStatus_To_api_VolumeSnapshotDataStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_VolumeSnapshotData_To_api_VolumeSnapshotData is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotData_To_api_VolumeSnapshotData(in *VolumeSnapshotData, out *api.VolumeSnapshotData, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotData_To_api_VolumeSnapshotData(in, out, s)
}

func autoConvert_api_VolumeSnapshotData_To_v1_VolumeSnapshotData(in *api.VolumeSnapshotData, out *VolumeSnapshotData, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_api_VolumeSnapshotDataSpec_To_v1_VolumeSnapshotDataSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_api_VolumeSnapshotDataStatus_To_v1_VolumeSnapshotDataStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_VolumeSnapshotData_To_v1_VolumeSnapshotData is an autogenerated conversion function.
func Convert_api_VolumeSnapshotData_To_v1_VolumeSnapshotData(in *api.VolumeSnapshotData, out *VolumeSnapshotData, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotData_To_v1_VolumeSnapshotData(in, out, s)
}

func autoConvert_v1_VolumeSnapshotDataCondition_To_api_VolumeSnapshotDataCondition(in *VolumeSnapshotDataCondition, out *api.VolumeSnapshotDataCondition, s conversion.Scope) error {
	out.Type = api.VolumeSnapshotDataConditionType(in.Type)
	out.Status = api.ConditionStatus(in.Status)
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
	out.Message = in.Message
...
// Convert_v1_VolumeSnapshotDataCondition_To_api_VolumeSnapshotDataCondition is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotDataCondition_To_api_VolumeSnapshotDataCondition(in *VolumeSnapshotDataCondition, out *api.VolumeSnapshotDataCondition, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotDataCondition_To_api_VolumeSnapshotDataCondition(in, out, s)
}

func autoConvert_api_VolumeSnapshotDataCondition_To_v1_VolumeSnapshotDataCondition(in *api.VolumeSnapshotDataCondition, out *VolumeSnapshotDataCondition, s conversion.Scope) error {
	out.Type = VolumeSnapshotDataConditionType(in.Type)
	out.Status = ConditionStatus(in.Status)
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
	out.Message = in.Message
...
// Convert_api_VolumeSnapshotDataCondition_To_v1_VolumeSnapshotDataCondition is an autogenerated conversion function.
func Convert_api_VolumeSnapshotDataCondition_To_v1_VolumeSnapshotDataCondition(in *api.VolumeSnapshotDataCondition, out *VolumeSnapshotDataCondition, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotDataCondition_To_v1_VolumeSnapshotDataCondition(in, out, s)
}

func autoConvert_v1_VolumeSnapshotDataList_To_api_VolumeSnapshotDataList(in *VolumeSnapshotDataList, out *api.VolumeSnapshotDataList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]api.VolumeSnapshotData, len(*in))
		for i := range *in {
			if err := Convert_v1_VolumeSnapshot_To_api_VolumeSnapshotData(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_v1_VolumeSnapshotDataList_To_api_VolumeSnapshotDataList is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotDataList_To_api_VolumeSnapshotDataList(in *VolumeSnapshotDataList, out *api.VolumeSnapshotDataList, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotDataList_To_api_VolumeSnapshotDataList(in, out, s)
}

func autoConvert_api_VolumeSnapshotDataList_To_v1_VolumeSnapshotDataList(in *api.VolumeSnapshotDataList, out *VolumeSnapshotDataList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VolumeSnapshot, len(*in))
		for i := range *in {
			if err := Convert_api_VolumeSnapshotData_To_v1_VolumeSnapshot(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.Items = make([]VolumeSnapshot, 0)
	}
	return nil
}

// Convert_api_VolumeSnapshotDataList_To_v1_VolumeSnapshotDataList is an autogenerated conversion function.
func Convert_api_VolumeSnapshotDataList_To_v1_VolumeSnapshotDataList(in *api.VolumeSnapshotDataList, out *VolumeSnapshotDataList, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotDataList_To_v1_VolumeSnapshotDataList(in, out, s)
}

func autoConvert_v1_VolumeSnapshotDataSource_To_api_VolumeSnapshotDataSource(in *VolumeSnapshotDataSource, out *api.VolumeSnapshotDataSource, s conversion.Scope) error {
	out.GCEPersistentDisk = (*api.GCEPersistentDiskVolumeSource)(unsafe.Pointer(in.GCEPersistentDisk))
	out.AWSElasticBlockStore = (*api.AWSElasticBlockStoreVolumeSource)(unsafe.Pointer(in.AWSElasticBlockStore))
	out.HostPath = (*api.HostPathVolumeSource)(unsafe.Pointer(in.HostPath))
	out.Glusterfs = (*api.GlusterfsVolumeSource)(unsafe.Pointer(in.Glusterfs))
...
// Convert_v1_VolumeSnapshotDataSource_To_api_VolumeSnapshotDataSource is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotDataSource_To_api_VolumeSnapshotDataSource(in *VolumeSnapshotDataSource, out *api.VolumeSnapshotDataSource, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotDataSource_To_api_VolumeSnapshotDataSource(in, out, s)
}

func autoConvert_api_VolumeSnapshotDataSource_To_v1_VolumeSnapshotDataSource(in *api.VolumeSnapshotDataSource, out *VolumeSnapshotDataSource, s conversion.Scope) error {
	out.GCEPersistentDisk = (*GCEPersistentDiskVolumeSource)(unsafe.Pointer(in.GCEPersistentDisk))
	out.AWSElasticBlockStore = (*AWSElasticBlockStoreVolumeSource)(unsafe.Pointer(in.AWSElasticBlockStore))
	out.HostPath = (*HostPathVolumeSource)(unsafe.Pointer(in.HostPath))
	out.Glusterfs = (*GlusterfsVolumeSource)(unsafe.Pointer(in.Glusterfs))
...
// Convert_api_VolumeSnapshotDataSource_To_v1_VolumeSnapshotDataSource is an autogenerated conversion function.
func Convert_api_VolumeSnapshotDataSource_To_v1_VolumeSnapshotDataSource(in *api.VolumeSnapshotDataSource, out *VolumeSnapshotDataSource, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotDataSource_To_v1_VolumeSnapshotDataSource(in, out, s)
}

func autoConvert_v1_VolumeSnapshotDataSpec_To_api_VolumeSnapshotDataSpec(in *VolumeSnapshotDataSpec, out *api.VolumeSnapshotDataSpec, s conversion.Scope) error {
	if err := Convert_v1_VolumeSnapshotDataSource_To_api_VolumeSnapshotDataSource(&in.VolumeSnapshotDataSource, &out.VolumeSnapshotDataSource, s); err != nil {
		return err
	}
	out.VolumeSnapshotRef = (*api.ObjectReference)(unsafe.Pointer(in.VolumeSnapshotRef))
	out.PersistentVolumeRef = (*api.ObjectReference)(unsafe.Pointer(in.PersistentVolumeRef))
	return nil
}

// Convert_v1_VolumeSnapshotDataSpec_To_api_VolumeSnapshotDataSpec is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotDataSpec_To_api_VolumeSnapshotDataSpec(in *VolumeSnapshotDataSpec, out *api.VolumeSnapshotDataSpec, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotDataSpec_To_api_VolumeSnapshotDataSpec(in, out, s)
}

func autoConvert_api_VolumeSnapshotDataSpec_To_v1_VolumeSnapshotDataSpec(in *api.VolumeSnapshotDataSpec, out *VolumeSnapshotDataSpec, s conversion.Scope) error {
	if err := Convert_api_VolumeSnapshotDataSource_To_v1_VolumeSnapshotDataSource(&in.VolumeSnapshotDataSource, &out.VolumeSnapshotDataSource, s); err != nil {
		return err
	}
	out.VolumeSnapshotRef = (*ObjectReference)(unsafe.Pointer(in.VolumeSnapshotRef))
	out.PersistentVolumeRef = (*ObjectReference)(unsafe.Pointer(in.PersistentVolumeRef))
	return nil
}

// Convert_api_VolumeSnapshotDataSpec_To_v1_VolumeSnapshotDataSpec is an autogenerated conversion function.
func Convert_api_VolumeSnapshotDataSpec_To_v1_VolumeSnapshotDataSpec(in *api.VolumeSnapshotDataSpec, out *VolumeSnapshotDataSpec, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotDataSpec_To_v1_VolumeSnapshotDataSpec(in, out, s)
}

func autoConvert_v1_VolumeSnapshotDataStatus_To_api_VolumeSnapshotDataStatus(in *VolumeSnapshotDataStatus, out *api.VolumeSnapshotDataStatus, s conversion.Scope) error {
	out.CreationTimestamp = in.CreationTimestamp
	out.Conditions = *(*[]api.VolumeSnapshotDataCondition)(unsafe.Pointer(&in.Conditions))
	return nil
}

// Convert_v1_VolumeSnapshotDataStatus_To_api_VolumeSnapshotDataStatus is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotDataStatus_To_api_VolumeSnapshotDataStatus(in *VolumeSnapshotDataStatus, out *api.VolumeSnapshotDataStatus, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotDataStatus_To_api_VolumeSnapshotDataStatus(in, out, s)
}

func autoConvert_api_VolumeSnapshotDataStatus_To_v1_VolumeSnapshotDataStatus(in *api.VolumeSnapshotDataStatus, out *VolumeSnapshotDataStatus, s conversion.Scope) error {
	out.CreationTimestamp = in.CreationTimestamp
	if in.Conditions == nil {
		out.Conditions = make([]VolumeSnapshotDataCondition, 0)
	} else {
		out.Conditions = *(*[]VolumeSnapshotDataCondition)(unsafe.Pointer(&in.Conditions))
	}
	return nil
}

// Convert_api_VolumeSnapshotDataStatus_To_v1_VolumeSnapshotDataStatus is an autogenerated conversion function.
func Convert_api_VolumeSnapshotDataStatus_To_v1_VolumeSnapshotDataStatus(in *api.VolumeSnapshotDataStatus, out *VolumeSnapshotDataStatus, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotDataStatus_To_v1_VolumeSnapshotDataStatus(in, out, s)
}

func autoConvert_v1_VolumeSnapshotList_To_api_VolumeSnapshotList(in *VolumeSnapshotList, out *api.VolumeSnapshotList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]api.VolumeSnapshot)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1_VolumeSnapshotList_To_api_VolumeSnapshotList is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotList_To_api_VolumeSnapshotList(in *VolumeSnapshotList, out *api.VolumeSnapshotList, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotList_To_api_VolumeSnapshotList(in, out, s)
}

func autoConvert_api_VolumeSnapshotList_To_v1_VolumeSnapshotList(in *api.VolumeSnapshotList, out *VolumeSnapshotList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items == nil {
		out.Items = make([]VolumeSnapshot, 0)
	} else {
		out.Items = *(*[]VolumeSnapshot)(unsafe.Pointer(&in.Items))
	}
	return nil
}

// Convert_api_VolumeSnapshotList_To_v1_VolumeSnapshotList is an autogenerated conversion function.
func Convert_api_VolumeSnapshotList_To_v1_VolumeSnapshotList(in *api.VolumeSnapshotList, out *VolumeSnapshotList, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotList_To_v1_VolumeSnapshotList(in, out, s)
}

func autoConvert_v1_VolumeSnapshotSpec_To_api_VolumeSnapshotSpec(in *VolumeSnapshotSpec, out *api.VolumeSnapshotSpec, s conversion.Scope) error {
	out.PersistentVolumeClaimName = in.PersistentVolumeClaimName
	out.SnapshotDataName = in.SnapshotDataName
	return nil
}

// Convert_v1_VolumeSnapshotSpec_To_api_VolumeSnapshotSpec is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotSpec_To_api_VolumeSnapshotSpec(in *VolumeSnapshotSpec, out *api.VolumeSnapshotSpec, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotSpec_To_api_VolumeSnapshotSpec(in, out, s)
}

func autoConvert_api_VolumeSnapshotSpec_To_v1_VolumeSnapshotSpec(in *api.VolumeSnapshotSpec, out *VolumeSnapshotSpec, s conversion.Scope) error {
	out.PersistentVolumeClaimName = in.PersistentVolumeClaimName
	out.SnapshotDataName = in.SnapshotDataName
	return nil
}

// Convert_api_VolumeSnapshotSpec_To_v1_VolumeSnapshotSpec is an autogenerated conversion function.
func Convert_api_VolumeSnapshotSpec_To_v1_VolumeSnapshotSpec(in *api.VolumeSnapshotSpec, out *VolumeSnapshotSpec, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotSpec_To_v1_VolumeSnapshotSpec(in, out, s)
}

func autoConvert_v1_VolumeSnapshotStatus_To_api_VolumeSnapshotStatus(in *VolumeSnapshotStatus, out *api.VolumeSnapshotStatus, s conversion.Scope) error {
	out.CreationTimestamp = in.CreationTimestamp
	out.Conditions = *(*[]api.VolumeSnapshotCondition)(unsafe.Pointer(&in.Conditions))
	return nil
}

// Convert_v1_VolumeSnapshotStatus_To_api_VolumeSnapshotStatus is an autogenerated conversion function.
func Convert_v1_VolumeSnapshotStatus_To_api_VolumeSnapshotStatus(in *VolumeSnapshotStatus, out *api.VolumeSnapshotStatus, s conversion.Scope) error {
	return autoConvert_v1_VolumeSnapshotStatus_To_api_VolumeSnapshotStatus(in, out, s)
}

func autoConvert_api_VolumeSnapshotStatus_To_v1_VolumeSnapshotStatus(in *api.VolumeSnapshotStatus, out *VolumeSnapshotStatus, s conversion.Scope) error {
	out.CreationTimestamp = in.CreationTimestamp
	if in.Conditions == nil {
		out.Conditions = make([]VolumeSnapshotCondition, 0)
	} else {
		out.Conditions = *(*[]VolumeSnapshotCondition)(unsafe.Pointer(&in.Conditions))
	}
	return nil
}

// Convert_api_VolumeSnapshotStatus_To_v1_VolumeSnapshotStatus is an autogenerated conversion function.
func Convert_api_VolumeSnapshotStatus_To_v1_VolumeSnapshotStatus(in *api.VolumeSnapshotStatus, out *VolumeSnapshotStatus, s conversion.Scope) error {
	return autoConvert_api_VolumeSnapshotStatus_To_v1_VolumeSnapshotStatus(in, out, s)
}
