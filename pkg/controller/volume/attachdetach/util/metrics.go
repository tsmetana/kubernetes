...
var adControllerVolumesMetric = prometheus.NewGaugeVec(
...
func RecordADControllerVolumesMetric(state string, number int) {
	adControllerVolumesMetric.WithLabelValues(state).Set(float64(number))
}
