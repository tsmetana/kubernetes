...
func newVolumeSnapshotDataInformer(client clientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *volumeSnapshotDataInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&api_v1.VolumeSnapshotData{}, newVolumeSnapshotDataInformer)
}
